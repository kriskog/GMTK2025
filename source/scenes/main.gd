...
#Before emitting this signal, await completion of the victory fanfare (~10s or await Global.Audio_manager.sound_finished) or require confirmation by the user before moving on to rolling credits. Await cannot be used in a signal function.
